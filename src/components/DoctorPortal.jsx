          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
            <div>
              ...
              <div className="space-y-2">
                ...
                {/* Selected date display and calendar toggle */}
                <div className="w-full">
                  <button
                    onClick={() => setShowCalendar(!showCalendar)}
                    className="w-full flex items-center justify-between p-3 bg-blue-50 border border-blue-200 rounded-lg mb-2 hover:bg-blue-100 transition-colors cursor-pointer"
                  >
                    ...
                    <svg className={`w-4 h-4 text-blue-600 transition-transform ${showCalendar ? 'rotate-180' : ''}`} fill="none" stroke="currentColor" viewBox="0 0 24 24">
                  ...
                  return (
                    <button
                      ...
                      onClick={() => {
                        ...
                        setShowCalendar(false); // Auto-collapse calendar on date selection
                      }}
                      className={`
              ...
              <div className="mt-4 flex justify-center">
                <button
                  onClick={() => {
                    ...
                    setShowCalendar(false); // Auto-collapse calendar when going to today
                  }}
